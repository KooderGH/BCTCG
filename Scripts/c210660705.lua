...
-- (3) During damage calulation, if this card battles an opponent's monster, you can banish one DARK monster from your graveyard, this card ATK becomes 5000 during that damage calculation only.
local s,id=GetID()
