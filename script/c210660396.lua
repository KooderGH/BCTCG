...
-- (2) When this card is Tribute Summoned, target up to 3 card(s) on the field; destroy those targets.
-- (3) This card gains 500 ATK for each face-up FIRE monster on the field, except this card.
-- (4) If this card is destroyed by card effect: Look at your opponent's hand; Destroy 1 card in your opponent's hand.
-- (5) When this card is destroyed by battle: You can add one Dragon monster from your deck to your hand.
