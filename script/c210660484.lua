--Li'l Valkyrie Dark
--Scripted by Gideon
-- (1) Cannot be Normal Summoned/Set. Must be Special Summoned (from your hand) by having 3 or more DARK monsters with different names in your GY while controlling no monsters.
...
-- (4) Once per turn (Quick): You can make your opponent send 1 monster from their hand or their side of the field to the GY (their choice).
local s,id=GetID()
...
function s.spcon(e,c)
	if c==nil and Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0,nil)==0 then return true end
