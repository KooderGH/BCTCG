...
-- (2) When this card is Summoned; Add 1 Level 4 or lower Earth Machine type monsters from your deck to your hand. You can only activate this effect of "Mighty Aethur Ltd." once per turn.
-- (3) Once per turn, if this card would be destroyed by battle: Gain 500 ATK instead.
