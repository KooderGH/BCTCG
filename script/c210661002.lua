...
function s.initial_effect(c)
	...
	e18:SetDescription(aux.Stringid(id,10))
	...
	--lower this card's DEF by 500 to Special Summon 1 "Thermae K41 Token" (11)
	--local e19=Effect.CreateEffect(c)
	--e19:SetDescription(aux.Stringid(id,11))
	--e19:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_TOKEN)
	--e19:SetType(EFFECT_TYPE_IGNITION)
	--e19:SetRange(LOCATION_MZONE)
	--e19:SetCountLimit(2,{id,1},EFFECT_COUNT_CODE_OATH)
	--e19:SetTarget(s.ssttg3)
	--e19:SetOperation(s.sstpop3)
	...
	e21:SetDescription(aux.Stringid(id,8))
	e21:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e21:SetRange(LOCATION_MZONE)
	e21:SetCode(EVENT_PHASE+PHASE_STANDBY)
	e21:SetLabel(2)
	e21:SetCountLimit(1)
	e21:SetCondition(s.pilecountcondition)
	e21:SetOperation(s.defop2)
	c:RegisterEffect(e21)
	--3+ (12)
	local e22=Effect.CreateEffect(c)
	e22:SetDescription(aux.Stringid(id,9))
    e22:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e22:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_IGNITION)
	e22:SetRange(LOCATION_MZONE)
	e22:SetLabel(3)
	e22:SetCondition(s.pilecountcondition)
	e22:SetCost(s.trcost)
	e22:SetTarget(s.trtg)
	e22:SetOperation(s.trop)
	c:RegisterEffect(e22)
	--Cannot set
	local e23=Effect.CreateEffect(c)
	e23:SetType(EFFECT_TYPE_FIELD)
	e23:SetCode(EFFECT_CANNOT_MSET)
	e23:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e23:SetRange(LOCATION_MZONE)
	e23:SetTargetRange(0,1)
	e23:SetLabel(4)
	...
	local e25=e23:Clone()
	e25:SetCode(EFFECT_CANNOT_TURN_SET)
	c:RegisterEffect(e25)
	local e26=e23:Clone()
	e26:SetCode(EFFECT_CANNOT_SPECIAL_SUMMON)
	e26:SetTarget(s.sumlimit)
