...
--Scripted by Kooder
--Effects:
-- When this card is Summoned; Add 1 "TARMA", "ERI", or "FIO" from your Deck or GY to your hand.
...
-- * Send 2 cards from the bottom of their Deck to the GY.
local s,id=GetID()
...
function s.thfilter(c)
	return c:IsAbleToHand() and c:IsCode(210661216) or c:IsCode(210661217) or c:IsCode(210661218)
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local b1=Duel.IsExistingTarget(Card.IsAbleToDeck,tp,0,LOCATION_ONFIELD,1,nil)
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==1 then
		...
		-- 2 Cards from the bottom deck to the GY
		local bt=Duel.GetDeckbottomGroup(1-tp,2)
