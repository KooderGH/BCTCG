...
function s.initial_effect(c)
    ...
    c:RegisterEffect(e1)
    --Warrior player controls gain 100 ATK
    ...
    e3:SetValue(function(e,c) return c:IsFaceup() and c:IsRace(RACE_MACHINE) end)
    c:RegisterEffect(e3)
end
...
function s.adval(e,c)
	return Duel.GetMatchingGroupCount(aux.FaceupFilter(Card.IsRace,RACE_WARRIOR),c:GetControler(),LOCATION_MZONE,0,nil)*100
end