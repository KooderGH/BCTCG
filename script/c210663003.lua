...
--(4) When a card or effect is activated (Quick Effect): You can Tribute this card; negate the activation, and if you do, destroy it. During the End Phase, if this effect was activated this turn (and was not negated): Special Summon this card from your GY.
--(5) If this card battles a Zombie type monster; Banish it at the start of the damage step.
--(6) If this card battles a Fairy type monster; negate the attack and negate its effects while this card is face-up on the field at the start of the damage step.
--(7) If this card battles a Machine type monster; Take control of it at the start of the damage step.
--(8) If this card is in your GY: You can pay half your LP; Special Summon this card from your GY
--(9) You can only control one "Type-URR Support".
local s,id=GetID()
function s.initial_effect(c)
    ...
    e8:SetCost(s.graverecoverycost)
    e8:SetTarget(s.graverecoverytg)
    e8:SetOperation(s.graverecoveryop)
    c:RegisterEffect(e8)
end
