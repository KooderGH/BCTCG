...
s.listed_names={210668004,210668005,210668006,210668007}
function s.check(g)
	local a1=false
	local a2=false
	local a3=false
	...
	for tc in aux.Next(g) do
		...
		if code==210668004 then a1=true
			elseif code==210668005 then a2=true
			elseif code==210668006 then a3=true
			elseif code==210668007 then a4=true
